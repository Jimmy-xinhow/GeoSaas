        ...
        <section>
          ...
          <Table
            ...
            rows={[
              ...
              ['Starter', '690', '1 個網站、6 次掃描、20 點方案 AI 額度、10 次 QA、20 次監控、每週 1 篇 AI 專屬內容、2 份報告'],
              ['Pro', '1090', '3 個網站、10 次掃描、站內深度分析、40 點方案 AI 額度、15 次 QA、30 次監控、每週 3 篇 AI 專屬內容、多平台支援、自動排程、3 份報告'],
